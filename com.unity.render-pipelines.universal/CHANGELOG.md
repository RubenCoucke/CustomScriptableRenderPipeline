...
- Fixed an issue that caused depth texture to be flipped when sampling from shaders [case 1114576](https://issuetracker.unity3d.com/issues/lwrp-depth-texture-flipy)
